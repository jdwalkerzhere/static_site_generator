...
class TestWholeInlinePipe(unittest.TestCase):
    def test_whole_inline_pipe(self):
        markdown_doc = [
            TextNode(text="# I am a header no special treatment", type=TextType.TEXT),
            TextNode(
                text="[i am a link](i should get split) and ![i am an image](split me)",
                type=TextType.TEXT,
            ),
            TextNode(
                text="and *i* **am** `special text` that [should](get) ![split](up)",
                type=TextType.TEXT,
            ),
        ]
        ...
        expected_images = [
            ...
            TextNode(
                text="and *i* **am** `special text` that [should](get) ",
                type=TextType.TEXT,
            ),
